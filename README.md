...
4-	Juegos: un boton de test general que redirige a la página del test correspondiente. Este seria el de nivel basico, ya que al finalizar, se le da al usuario la opcion de volver al menu de juegos o realizar el test de nivel medio. 
5-	Contacto: con validacion javascript, formulario que consta de Nombre, correo, razon y descripcion.
6-	Log in: para que los usuarios puedan registrarse y tener acceso a la edición/creación de noticias.
